        ...
        <div class="add-tab-row  push-padding-bottom">
            <div class="row">
                ...
                <?php if ($hide_add_prop_fields['neighborhood'] != 1) { ?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="neighborhood"><?php echo esc_html__( 'Municipalities', 'houzez' ); ?></label>
                            <?php if( $location_dropdowns == 'yes' ) { ?>
                            ...
                            <?php } else { ?>
                                <input class="form-control" name="neighborhood" id="neighborhood" placeholder="<?php esc_html_e( 'Enter your property Municipality', 'houzez' ); ?>">
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
