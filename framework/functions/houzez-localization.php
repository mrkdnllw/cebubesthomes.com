	...
	function houzez_get_localization() {
		...
		$localization = array(
			...
			*------------------------------------------------------*/
			...
			'keyword_text' 		=> esc_html__( 'Search location', 'houzez' ),
			...
			'all_cities' 		=> esc_html__( 'Cities', 'houzez' ),
			'all_areas' 		=> esc_html__( 'Municipalities', 'houzez' ),
			'area_size' 		=> esc_html__( 'Area Size', 'houzez' ),
			'all_status' 		=> esc_html__( 'Property Offering', 'houzez' ),
			'all_types' 		=> esc_html__( 'Type of Property', 'houzez' ),
			'all_labels' 		=> esc_html__( 'Status', 'houzez' ),
			'property_id' 		=> esc_html__( 'Property ID (Leave blank if not known)', 'houzez' ),
